...
#define DEFAULT_CLIENT_NAME     @"Fluidium"
#define DEFAULT_CLIENT_VERSION  @"0.10"
#define DEFAULT_CLIENT_URL      @"http://fluidapp.com"
#define DEFAULT_CLIENT_TOKEN	@"fluidium"
...
//        [params setObject:[NSString stringWithFormat:@"%qu", sinceID] forKey:@"since_id"];
        [params setObject:[[NSNumber numberWithUnsignedLongLong:sinceID] stringValue] forKey:@"since_id"];
    }
    if (maxID > 0) {
...
//        [params setObject:[NSString stringWithFormat:@"%qu", maxID] forKey:@"max_id"];
        [params setObject:[[NSNumber numberWithUnsignedLongLong:maxID] stringValue] forKey:@"max_id"];
    }
    // END TODD
    // (changed the format from %u to %qu on these two
...
{
    NSString *path = [NSString stringWithFormat:@"statuses/show/%@.%@", [[NSNumber numberWithUnsignedLongLong:updateID] stringValue], API_FORMAT];
