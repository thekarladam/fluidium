...
{
	static const CGFunctionCallbacks callbacks = {0, (CGFunctionEvaluateCallback)&linearShadedColor, NULL};
...
{
	static const CGFunctionCallbacks callbacks = {0, (CGFunctionEvaluateCallback)&bilinearShadedColor, NULL};
