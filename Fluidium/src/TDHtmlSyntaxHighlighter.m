...
@property (nonatomic, retain) PKToken *ltToken;
@property (nonatomic, retain) PKToken *gtToken;
@property (nonatomic, retain) PKToken *startCommentToken;
@property (nonatomic, retain) PKToken *endCommentToken;
@property (nonatomic, retain) PKToken *startCDATAToken;
@property (nonatomic, retain) PKToken *endCDATAToken;
@property (nonatomic, retain) PKToken *startPIToken;
@property (nonatomic, retain) PKToken *endPIToken;
@property (nonatomic, retain) PKToken *startDoctypeToken;
@property (nonatomic, retain) PKToken *fwdSlashToken;
@property (nonatomic, retain) PKToken *eqToken;
@property (nonatomic, retain) PKToken *scriptToken;
@property (nonatomic, retain) PKToken *endScriptToken;
@end
